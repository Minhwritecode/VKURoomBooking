...
story = [
    ...
    Table([[P("Student", "SmallCustom"), P("Dinh Tran Tien Minh · 23IT162", "SmallCustom")], [P("Date", "SmallCustom"), P("18/09/2026", "SmallCustom")], [P("Repository", "SmallCustom"), P("github.com/Minhwritecode/VKURoomBooking", "SmallCustom")], [P("Live demo", "SmallCustom"), P("Vercel URL cập nhật sau deployment", "SmallCustom")]], colWidths=[33 * mm, 130 * mm], style=TableStyle([("BACKGROUND", (0, 0), (0, -1), PALE), ("GRID", (0, 0), (-1, -1), 0.35, colors.HexColor("#D7E5F0")), ("VALIGN", (0, 0), (-1, -1), "TOP"), ("LEFTPADDING", (0, 0), (-1, -1), 7), ("TOPPADDING", (0, 0), (-1, -1), 6), ("BOTTOMPADDING", (0, 0), (-1, -1), 6)])),
    Spacer(1, 10 * mm),
